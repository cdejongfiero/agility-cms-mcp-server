...
interface ContainerOverview {
  ...
  topContainersByContent: ContainerInfo[];
  recentlyModified: ContainerInfo[];
...
class ContainerOverviewResource extends MCPResource {
  ...
  private cachedOverview: ContainerOverview | null = null;
  private lastFetch: number = 0;
  private readonly CACHE_TTL = thirtyMinutes; // Cache for 30 minutes
  ...
  private async refreshCache(): Promise<void> {
    ...
    try {
      ...
      const containersWithCounts: ContainerInfo[] = [];
