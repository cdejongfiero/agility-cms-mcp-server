...
import { getRequiredEnvVar, getOptionalEnvVar, createListParams, handleApiError } from '../types/index.js';
...
class GetContentItemsTool extends MCPTool {
    ...
    async execute(input) {
        try {
            ...
            const contentList = await apiClient.contentMethods.getContentItems(input.referenceName, guid, locale, listParams);
            return {
                success: true,
