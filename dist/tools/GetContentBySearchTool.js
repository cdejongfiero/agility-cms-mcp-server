...
import { getRequiredEnvVar, getOptionalEnvVar, searchContentInContainer } from '../types/index.js';
// Load environment variables
dotenv.config();
class GetContentBySearchTool extends MCPTool {
    ...
    async execute(input) {
        ...
        try {
            ...
            const searchResults = await searchContentInContainer(apiClient, input.referenceName, input.searchTerm, searchField, guid, locale);
