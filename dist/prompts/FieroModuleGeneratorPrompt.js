...
class FieroModuleGeneratorPrompt extends MCPPrompt {
    ...
    async generateMessages({ modelReferenceName, moduleType = "content", includeErrorBoundary = true, includeTypeform = false, includeProductIntegration = false }) {
        return [
            {
                role: "system",
                content: {
